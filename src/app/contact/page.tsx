              ...
              <dl className="mt-10 space-y-4 text-base leading-7 text-gray-600">
                <div className="flex gap-x-4">
                  <dt className="flex-none">
                    ...
                    <MapPinIcon className="h-7 w-6 text-orange-400" aria-hidden="true" />
                  </dt>
                  <dd>
                    123 Main Street
                    <br />
                ...
                <div className="flex gap-x-4">
                  <dt className="flex-none">
                    ...
                    <PhoneIcon className="h-7 w-6 text-orange-400" aria-hidden="true" />
                  </dt>
                  <dd>
                    <a className="hover:text-orange-900" href="tel:+27 12 345 6789">
                      +27 12 345 6789
                    </a>
                  </dd>
                </div>
                <div className="flex gap-x-4">
                  <dt className="flex-none">
                    ...
                    <EnvelopeIcon className="h-7 w-6 text-orange-400" aria-hidden="true" />
                  </dt>
                  <dd>
                    <a className="hover:text-orange-900" href="mailto:info@realestate.com">
                      info@realestate.com
                    </a>
                  </dd>
                </div>
